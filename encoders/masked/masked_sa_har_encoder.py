...
class MaskedSAHAREncoder(nn.Module):
    """
    Masked Reconstruction wrapper for SA-HAR encoder
    """
    def __init__(self, config):
        super(MaskedSAHAREncoder, self).__init__()
        
        # Create base encoder (without ECDF prediction heads)
        self.base_encoder = SAHAREncoder(config)
