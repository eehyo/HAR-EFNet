...
class SimCLRSAHAREncoder(nn.Module):
    """
    SimCLR SA-HAR Encoder class
    Add projection head to the existing SA-HAR encoder for contrastive learning
    """
    def __init__(self, args: Dict[str, Any]):
        """
        Initialize SimCLR SA-HAR encoder
        
        Args:
            args: Model configuration parameters (Dict)
        """
        super(SimCLRSAHAREncoder, self).__init__()
